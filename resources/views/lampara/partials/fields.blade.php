<div class="col-sm-4">
	...
	<div class="form-group">
		{!! Form::text('marca', null, ['class'=>'form-control floating-label','placeholder'=>'IdentificaciÓn:','required']) !!}
				<!--VALIDACION -->
	...
	@foreach($luminarias as $luminaria)
			...
			<option value="{{ $luminaria->id }} "<?php if($luminaria['id']==$lampara['luminaria_id']) echo 'selected' ; ?>>{{ $luminaria->identificacion }}</option>
